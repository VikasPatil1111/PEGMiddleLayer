...
namespace PEGMiddleLayer.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public async Task<IEnumerable<tblMainMenu>> getmenulist(string company)
        {
                try
                {               
                ...
                List<string> Roles = new List<string>();
                    ...
                    var RoleDetails = getAccess.Where(res => Roles.Contains(res.Role_Id)); // from role in getAccess
