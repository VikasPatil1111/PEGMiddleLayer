...
namespace PEGMiddleLayer.Models.Dashboard
{
    ...
    {
        public string Company_Code { get; 
            set; }
        public string Branch_Name   { get; 
            set; }
        public string Customer_Code   { get; 
            set; }
        ...
        public string Action_Code { 
            get; 
            set; }
        public string Action_Description { get; 
            set; }
        ...
        public double? Fg_Val_MtcIssue {
            get; 
            set; }
        public double? Fg_Val_MtcNotIssue { get; 
            set; }
        public double? MCH_Total_Val { get; 
            set; }
        ...
        public double? MCH_Sales_Val { 
            get; 
            set; }
        public double? Order_Val_Clear_For_Prod { get; 
            set; }
        public double? Order_Val_Pend_For_GA_Prep { get; 
            set; }
        public double? Order_Val_Pend_For_QAP_Prep { get;
            set; }
        public double? Order_Val_Pend_For_IntQAP_App { get;
            
            set; }
        public double? Order_Val_Pend_For_GAAcept_Eng { get; 
            set; }
        public double? Order_Val_Pend_For_Bom_Release { get; 
            set; }
        public double? Order_Val_Pend_For_Cont_Review { get; 
            set; }
        public double? Order_Val_Pend_For_Tech_Clar { get; 
            set; }
        public double? Order_Val_Pend_ForGAAppFrCust { get; 
            set; }
        public double? Order_Val_Pend_ForQAPAppFrCust { get; 
            set; }
        public double? Order_Val_Pend_For_Cst_Clr { get; 
            set; }
        public double? Order_Val_Pend_ForCstClrCMDApp { get; 
            set; }
        public double? Order_Val_Pend_For_Mktg_Hold { get; 
            set; }
